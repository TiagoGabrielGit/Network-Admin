        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="Localidade-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="/estado.php">
                            <i class="bi bi-circle"></i><span>Estado</span>
                        </a>
                    </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#telecom-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-layout-text-window-reverse"></i><span>Telecom</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>

                <ul id="telecom-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
