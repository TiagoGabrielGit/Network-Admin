...
$sql = "INSERT INTO chamados (atendente_id, assuntoChamado, tipochamado_id, solicitante_id, empresa_id, status_id, data_abertura, in_execution, in_execution_atd_id)
        VALUES ('0', :assuntoChamado, :tipochamado_id, :solicitante_id, :empresa_id, '1', NOW(), '0', '0')";
...
if ($id_chamado && $cont_insert) {
    $sql_relato = "INSERT INTO chamado_relato (chamado_id, relator_id, relato, relato_hora_inicial, relato_hora_final)
    VALUES (:chamado_id, :relator_id, :relato, NOW(), NOW())";
