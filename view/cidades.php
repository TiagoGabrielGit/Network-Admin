...
$result_cidade = "SELECT * FROM cidades WHERE id = '$id'";
$resultado_cidade = mysqli_query($mysqli, $result_cidade);
$row_cidade = mysqli_fetch_assoc($resultado_cidade);
?>
...
<head>
    ...
    <title>Cidades - Network Academy</title>
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo $row_cidade['cidade']; ?> - <?php echo $row_cidade['estado']; ?> / <?php echo $row_cidade['pais']; ?></h5>

                            <!-- Multi Columns Form -->
                            <form method="POST" action="/processa_edit/cidades.php" class="row g-3">
                                <input type="hidden" name="id" value="<?php echo $row_cidade['id']; ?>">

                                <div class="row mb-3">
                                    <label for="codigo" class="col-sm-12 col-form-label">Código</label>
                                    <div class="col-sm-2">
                                        <input name="codigo" type="text" class="form-control" id="codigo" value="<?php echo $row_cidade['id']; ?>" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input name="cidade" type="text" class="form-control" id="inputCidade" value="<?php echo $row_cidade['cidade']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="pais" id="inputPaís" class="form-select">
                                        <option selected><?php echo $row_cidade['pais']; ?></option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="estado" id="inputEstado" class="form-select">
                                        <option selected><?php echo $row_cidade['estado']; ?></option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-6">
                                        <input name="dateCreated" type="text" class="form-control" id="dateCreated" value="<?php echo $row_cidade['criado']; ?>" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-sm-6">
                                        <input name="dateModified" type="text" class="form-control" id="dateModified" value="<?php echo $row_cidade['modificado']; ?>" disabled>
                                    </div>
                                </div>
