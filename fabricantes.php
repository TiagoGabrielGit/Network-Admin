                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            ...
                                            <?php echo "<a href='processa_delete/fabricante.php?id=" . $campos['id'] . "' data-confirm='Tem certeza que deseja excluir permanentemente esse registro?'" . " class='bi bi-x-square-fill' </a>"; ?>
                                        </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
